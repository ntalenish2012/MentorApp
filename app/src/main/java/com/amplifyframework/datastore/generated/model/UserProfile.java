...
public final class UserProfile implements Model {
  ...
  public static final QueryField BIO = field("bio");
  ...
  private UserProfile(String id, String name, String email, String role, String bio, String image) {
    this.id = id;
    this.name = name;
    this.email = email;
    this.role = role;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), userProfile.getId()) &&
              ...
              ObjectsCompat.equals(getRole(), userProfile.getRole()) &&
              ObjectsCompat.equals(getBio(), userProfile.getBio()) &&
              ObjectsCompat.equals(getImage(), userProfile.getImage());
      }
  }
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String email, String role, String bio, String image) {
      super.id(id);
      super.name(name)
        .email(email)
        .role(role)
